    ...
    <div class="col-lg-12">
        <div class="panel panel-default color">
            ...
            <div class="panel-body panel-form">
                ...
                <ul class="nav nav-tabs">
                            ...
                            <form action="cargarvista" method="post">     
                                ...
                                <tr>
                                    <td>Código CUPS<br> 
                                         <div class="col-lg-4">
                                           <input required type="text" class="form-control" placeholder="Código CUPS">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
              ...
              <label for="" class="col-lg-2"> Grupo: (Área de Laboratorio)</label> 
                 <div class="col-lg-4">
                            
                        <select class="form-control"  id="selec">
                             <option value="m"> Hematología </option>
                             <option value="f"> Uroanálisis </option>
                             <option value="i"> Coagulación </option>                                     
                         </select>
                        </div>
                </td>
            </tr>
           ...
           <tr>
                <td>
                    <label for="" class="col-lg-2">Número de Decimales de la Prueba:</label> 
                        <div class="col-lg-4">
                            <select class="form-control">
                    ...
                    <label for="" class="col-lg-2"> Tipo de Técnica:</label> 
                 <div class="col-lg-4">
                    <select class="form-control" >
                             <option value="m">  Técnica 1 </option>
                             <option value="f"> Técnica  2 </option>
                             <option value="i"> Técnica 3 </option>                                     
                         </select>
                 </div>
                </td>
            </tr>
