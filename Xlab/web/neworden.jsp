...
<html lang="en">
 ...
 <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <input required type="text" class="form-control" placeholder="Número de Documento">
            </div>
        </td>
    </tr>
     <tr><td>
            ...
            <tr>
                <td>
                     <label  class="col-lg-2">Dirección:</label> 
                        <div class="col-lg-4">
                            <input required type="text" class="form-control" placeholder="DirecciÃ³n">
                        </div>
                    <label  class="col-lg-2">Teléfono:</label> 
                 <div class="col-lg-4">
                    <input required type="text" class="form-control " placeholder="TelÃ©fono">
                 </div>
                </td>
            </tr>
          <!--  <tr>
            ...
            <tr>
                <td>
                    <label class="col-lg-2">No Cama:</label> 
                        <div class="col-lg-4">
                            <input required type="text" class="form-control" placeholder="NÃºmero de Cama">
                        </div>
                     ...
                     <label  class="col-lg-2">Diagnóstico:</label> 
                        <div class="col-lg-4">
                             <select class="form-control">
                               <script type="text/javascript">
                                  for (var i =0; i<=5; i++) {
                                    document.write("<option>Diagnóstico "+i+"</option>");
                               };
                                 </script>
                              </select>
                        </div>
            ...
            <tr>
                <td colspan="2">
                    <label  class="col-lg-2">No Autorización:</label> 
                        <div class="col-lg-4">
                            <input required type="text" class="form-control" placeholder="NÃºmero de Autorización">
                        </div>

                <label class="col-lg-2">Fecha Autorización:</label> 
            <div class="col-lg-4">                
                <input type="date" class="form-control input-sm">
                                ...
                                <div class="tab-pane fade" id="messages">
                                    <div class="cont-nestudio col-lg-12">
                                        <h4>Estudio a Programar: <strong> Aquí aparece el estudio...</strong></h4>
                                        <input type="text" class="form-control col-lg-3" placeholder="Código CUPS">
                                        <div class="col-lg-2">
